...
class BH1750:
    ...
    """
    # measurement : continue ou à un instant t
    ...
    def configure(self, measurement_mode: int, resolution: int, measurement_time: int):
        ...
        measurement_mode -- mesure continuellement ou à un instant t
        resolution -- renvoie la mesure en high / high2 / low resolution
        measurement_time -- la durée d'une mesure
        """
...
if not devices:
    print("No I2C devices found! Please check your VCC, GND, SDA, and SCL wiring.")
else:
    print(f"I2C device found at address: {hex(devices[0])}")
    

    sensor_address = devices[0] 
    

    try:
        sensor = BH1750(sensor_address, i2c)
        print("BH1750 initialized successfully! Starting measurements...\n")
